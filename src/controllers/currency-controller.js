...
const getAll = async (req, res, next) => {
  try {
    ...
    const result = await currencyService.getAll(data);
...
const getOne = async (req, res, next) => {
  try {
    const result = await currencyService.getOne(req.params.id);
    res.status(200).json({
      success: true,
      data: result,
    });
...
const destroy = async (req, res, next) => {
  try {
    const result = await currencyService.destroy(req.params.id);
    res.status(200).json({
      success: true,
      data: result,
    });
...
const destroyMany = async (req, res, next) => {
  try {
    const result = await currencyService.destroyMany(req.body);
    res.status(200).json({
      success: true,
      data: result,
    });
